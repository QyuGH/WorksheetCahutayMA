...
```{r}
#D. Yes, there is a relationship between the shoe size and height of the respondent because when the respondent's height is taller, chances are their shoe size also is higher.
```
...
#Both of the results shows useful relationship with each other. The summary of the months_vector provides the overall structure of the data while the results of factor_months_vector provides useful infortmation about the content of the data.
```
